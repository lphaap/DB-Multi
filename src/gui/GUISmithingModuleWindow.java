...
public class GUISmithingModuleWindow extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUISmithingModuleWindow frame = new GUISmithingModuleWindow(null,null,null);
	 ...
	 * Create the frame.
	 */
	public GUISmithingModuleWindow(ThreadController controller, ClientThread client, GUIMainWindow mainWindow) {
		...
		comboBoxType.setModel(new DefaultComboBoxModel(SmithingModule.SmithingType.values()));
		...
		comboBoxMaterial.setModel(new DefaultComboBoxModel(SmithingModule.SmithingMaterial.values()));
	...
	public void parseModule() {
		controller.addModule(new SmithingModule(controller, client, 
							(SmithingModule.SmithingType)this.comboBoxType.getSelectedItem(), 
							(SmithingModule.SmithingMaterial)this.comboBoxMaterial.getSelectedItem(), 
							(LocationFactory.GameLocation)this.comboBoxLocation.getSelectedItem(), 
							(int)this.limit.getValue()));
	}
	
	public void parseInfo() {
		mainWindow.addToList("SmithingModule: " + (this.comboBoxMaterial.getSelectedItem().toString()) + " " + (this.comboBoxType.getSelectedItem().toString()));
	}
